#include "LaBr_slab_DetectorConstruction.h"
#include "G4Box.hh"
...
LaBr_slab_DetectorConstruction::LaBr_slab_DetectorConstruction() {}

LaBr_slab_DetectorConstruction::~LaBr_slab_DetectorConstruction() {}

G4VPhysicalVolume* LaBr_slab_DetectorConstruction::Construct() {
...
for (int i = -1; i < 2; ++i) {
    ...
    //LaBr_slab_SensitiveDetector* detector = new LaBr_slab_SensitiveDetector("SensitiveDetector");
